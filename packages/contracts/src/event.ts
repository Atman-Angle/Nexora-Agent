...
export const EventTypeSchema = z.enum([
  ...
  "builder.mutation_intent.proposed",
  "builder.mutation_intent.accepted",
  "builder.mutation_intent.rejected",
  "artifact.created",
  "validation.started",
