...
function requiresWorkspace(command: Command): boolean { return command.type === "read" || command.type === "search" || command.type === "patch" || command.type === "verify" || command.type === "agent" || command.type === "approve" || command.type === "respond"; }
